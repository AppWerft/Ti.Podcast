...
namespace titanium {
	namespace bindings {
		...
		class TipodcastBindings {
			public:
				static BindEntry* lookupGeneratedInit(const char*, unsigned int);
		};

		BindEntry* TipodcastBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"de.appwerft.podcast.TipodcastModule", ::de::appwerft::podcast::TipodcastModule::bindProxy, ::de::appwerft::podcast::TipodcastModule::dispose}
			};
